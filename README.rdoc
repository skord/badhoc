...
If you can get past that, Badhoc has support for:

* Multiple Boards, Multiple Categories of Boards
* Application-level bans
* Markdown markup.
* Project Honeypot Blocklist Lock-outs
...
... see {Pivotal Tracker - Badhoc}[https://www.pivotaltracker.com/projects/190765]

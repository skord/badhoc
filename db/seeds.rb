...
board = Board.create!(:name => 'Random', :slug => 'b', :description => 'Random', :category_id => Category.find_or_create_by_name('Uncategorized').id)

board.posts.create!(:name => "skord", 
                    :email => "", 
                    :subject => "Welcome!", 
...
board.posts.update_all(:board_id => Board.find_by_name('Random').id, :client_ip => '127.0.0.1')
